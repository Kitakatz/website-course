...
const apiKey = 'b7ae8a71-a466-481d-afb5-45bef8b5a8ed';
let data = undefined;
let isLoading = false;
...
function getAllPokemon(url, apiKey) {
    return new Promise(function (resolve, reject) {
        ...
        HTTP.onerror = function () {
            reject(new Error('Network error ocorred.'));
        };
...
// function loadXhrRequest() {
//     const http = new XMLHttpRequest();

//     http.open('GET', 'https://api.pokemontcg.io/v2/cards/xy1-1');
//     http.setRequestHeader('X-Api-Key', 'b7ae8a71-a466-481d-afb5-45bef8b5a8ed');
...
//             console.log('data from global memory', data);
//         };
//     };
